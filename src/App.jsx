    ...
    <div className="font-poppins overflow-clip" >
      ...
      <header className="p-5 ">
        <div className="flex items-center justify-between">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 448 512"><path fill="#a0aec0" d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
        </div>
        ...
        <div className="relative top-8">
          <nav className="bg-dark-violet text-center text-white flex flex-col justify-center items-center absolute p-4 rounded-lg w-full">
            ...
            <ul className="w-full flex flex-col justify-center items-center py-4 leading-[3rem]">
              <li>Login</li>
              <li className="bg-cyan w-72 text-white rounded-3xl my-2"><button>Sign Up</button></li>
            </ul>
          </nav>
        </div>
      ...
      <main className="text-center">
        ...
        <section className="px-5">
          ...
          <div className="flex flex-col bg-shorten-mobile bg-no-repeat bg-dark-violet b bg-right-top justify-center items-center px-2 py-6 rounded-lg relative top-20">
            <input type="text" placeholder="Shorten a link here..." className="text-sm rounded-md w-72 p-3 mb-4"/>
            <button className="bg-cyan rounded-md w-72 p-3 text-white">Shorten it!</button>
          </div>
        </section>

        <section className="bg-slate-200">
          <h2 className="text-2xl pt-40 font-extrabold ">Advanced Statistics</h2>
          <p className="p-5">Track how your links are performing across the web with our advanced statistics dashboard.</p>

          <article className="bg-white mx-5 mt-16 rounded-md" >
          ...
          <article className="bg-white mx-5 m-16 rounded-md" >
            <div className=" rounded-full flex justify-center w-fit mx-auto bg-dark-violet relative bottom-10">
